...
Y por último desplegaremos sobre azure nuestro proyecto implementadolé Application Insight, para conocer
...
1. Nuestra Aplicación esta lista y utilizando Redis cache para todas sus operaciones :)
	...
	###Paso 3: Instalación de librerías necesarias (Entity Framework)
...
###Paso N: Creación del servicio de Redis cache en Azure
